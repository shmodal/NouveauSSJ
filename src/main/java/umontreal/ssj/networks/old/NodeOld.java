...
public class NodeOld
{
    ...
    */
   public NodeOld(int counter, int indice, int[] nLinks)
   {
    ...
    */
   @Override
   public NodeOld clone()
   {
      NodeOld image = null;

      try {
         image = (NodeOld) super.clone();
    ...
    */
   public boolean equals(NodeOld obj)
   {
      if (obj == null) {
         return false;
      }

      final NodeOld other = obj;
