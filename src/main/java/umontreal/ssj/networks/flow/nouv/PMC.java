...
public class PMC {
   ...
   // Initailisation des capacites et probas de façon spécifique(celle de rohan shah)
   ...
   public double run(int n, RandomStream stream,int demand,boolean flag, int[] tableauB,double rho,double epsilon) {
