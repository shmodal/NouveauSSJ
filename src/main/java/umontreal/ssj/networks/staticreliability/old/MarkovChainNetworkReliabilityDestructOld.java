 ...
 * @see MarkovChainNetworkReliabilityOld
 * @since juillet 2013
 */
public class MarkovChainNetworkReliabilityDestructOld extends MarkovChainNetworkReliabilityOld implements Cloneable
{
    ...
    */
   public MarkovChainNetworkReliabilityDestructOld(GraphWithForest forest, RandomStream streamPermut,
   		SamplerType sam)
   {
   ...
   protected void conditionalSample(RandomStream stream, int j)
   {
      ...
      if (flag)
         sampleOneLink(stream, 1.0/m_gamma, j);
      else
         sampleOneLink(stream, 0, j);
   }
   ...
   @Override
   public MarkovChainNetworkReliabilityDestructOld clone()
   {
      MarkovChainNetworkReliabilityDestructOld image = (MarkovChainNetworkReliabilityDestructOld) super.clone();
      return image;
   }
