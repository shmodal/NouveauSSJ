 ...
 * @since juillet 2013
 */
public class MarkovChainNetworkReliabilityShocksOld extends MarkovChainNetworkReliabilityDestructOld
    ...
    *           all the shocks
    */
   public MarkovChainNetworkReliabilityShocksOld(GraphWithForest forest, RandomStream streamPermut,
   ...
   protected void conditionalSample(RandomStream stream, int s) {
      ...
      if (flag)
         sampleOneShock(stream, s, 1.0 / m_gamma);
      else
   ...
   @Override
   public MarkovChainNetworkReliabilityShocksOld clone() {
      MarkovChainNetworkReliabilityShocksOld image = (MarkovChainNetworkReliabilityShocksOld) super.clone();
      image.shocks = shocks;
      image.kappa = kappa;
      return image;
   }
