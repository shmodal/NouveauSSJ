...
public class MarkovChainNetworkReliabilityAntiShocks1 extends MarkovChainNetworkReliabilityShocks 
    ...
    *           all the shocks
    */
   public MarkovChainNetworkReliabilityAntiShocks1(GraphWithForest forest, RandomStream streamPermut,
   ...
   @Override
   public MarkovChainNetworkReliabilityAntiShocks1 clone() {
      MarkovChainNetworkReliabilityAntiShocks1 image =
         (MarkovChainNetworkReliabilityAntiShocks1) super.clone();
