...
import umontreal.ssj.networks.staticreliability.old.MonteCarlo;
import umontreal.ssj.networks.staticreliability.old.MonteCarloShocks;
...
public class mctest {
   ...
   private static void proc(double q, String GraphName) throws IOException {
      ...
      GraphOld graph = new GraphOld(filename);
